    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-12">
          <div className="flex flex-col items-center">
            <div className="relative w-full max-w-4xl mx-auto">
              {/* Left side images */}
              <div className="absolute left-0 top-0 space-y-4 z-10 hidden md:block">
                <div className="rounded-lg overflow-hidden w-48 h-32">
                  <img 
                    src="https://emilist-tom.netlify.app/img/person1.jpg" 
                    alt="Professional" 
                ...
                <div className="rounded-lg overflow-hidden w-48 h-32">
                  <img 
                    src="https://emilist-tom.netlify.app/img/person2.jpg" 
                    alt="Professional" 
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="rounded-lg overflow-hidden w-48 h-32">
                  <img 
                    src="https://emilist-tom.netlify.app/img/person3.jpg" 
                    alt="Professional" 
                    className="w-full h-full object-cover"
                  />
                </div>
              ...
              {/* Right side images */}
              <div className="absolute right-0 top-0 space-y-4 z-10 hidden md:block">
                <div className="rounded-lg overflow-hidden w-48 h-32">
                  <img 
                    src="https://emilist-tom.netlify.app/img/person4.jpg" 
                    alt="Professional" 
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="rounded-lg overflow-hidden w-48 h-32">
                  <img 
                    src="https://emilist-tom.netlify.app/img/person5.jpg" 
                    alt="Professional" 
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="rounded-lg overflow-hidden w-48 h-32">
                  <img 
                    src="https://emilist-tom.netlify.app/img/person6.jpg" 
                    alt="Professional" 
                    className="w-full h-full object-cover"
                  />
                </div>
              ...
              {/* Center content */}
              <div className="text-center py-12 px-4 md:px-20 z-20 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-16">
          <Link href="/service-providers" className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
            <div className="mb-4">
              <div className="w-8 h-8 bg-[#E6F7EC] rounded-full flex items-center justify-center">
          ...
          <Link href="/job-opportunities" className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
            <div className="mb-4">
              <div className="w-8 h-8 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/materials" className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
            <div className="mb-4">
              <div className="w-8 h-8 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/customized-service" className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
            <div className="mb-4">
              <div className="w-8 h-8 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/planned-maintenance" className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
            <div className="mb-4">
              <div className="w-8 h-8 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

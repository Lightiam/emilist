    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-full max-w-5xl mx-auto">
              ...
              <div className="absolute inset-0 z-10 overflow-hidden">
                <img src="/assets/images/people/person1.jpg" alt="Professional" className="absolute top-10 left-10 w-20 h-20 rounded-full object-cover shadow-md" />
                <img src="/assets/images/people/person2.jpg" alt="Professional" className="absolute top-40 left-20 w-24 h-24 rounded-full object-cover shadow-md" />
                <img src="/assets/images/people/person3.jpg" alt="Professional" className="absolute top-20 right-20 w-24 h-24 rounded-full object-cover shadow-md" />
                <img src="/assets/images/people/person4.jpg" alt="Professional" className="absolute bottom-20 left-24 w-20 h-20 rounded-full object-cover shadow-md" />
                <img src="/assets/images/people/person5.jpg" alt="Professional" className="absolute bottom-40 right-16 w-24 h-24 rounded-full object-cover shadow-md" />
                <img src="/assets/images/people/person6.jpg" alt="Professional" className="absolute bottom-10 right-32 w-20 h-20 rounded-full object-cover shadow-md" />
              </div>
              
              {/* Center content */}
              <div className="text-center py-20 px-4 md:px-20 z-20 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-20">
          <Link href="/service-providers" className="bg-white rounded-2xl shadow-sm p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
            <div className="mb-4">
            ...
            <h3 className="text-lg font-medium">Service Provider</h3>
          </Link>
          
          <Link href="/job-opportunities" className="bg-white rounded-2xl shadow-sm p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
            <div className="mb-4">
              <div className="w-12 h-12 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/materials" className="bg-white rounded-2xl shadow-sm p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
            <div className="mb-4">
              <div className="w-12 h-12 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/customized-service" className="bg-white rounded-2xl shadow-sm p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
            <div className="mb-4">
              <div className="w-12 h-12 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3 className="text-lg font-medium">Customized Service<br/>Request</h3>
          </Link>
          
          <Link href="/planned-maintenance" className="bg-white rounded-2xl shadow-sm p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
            <div className="mb-4">
              <div className="w-12 h-12 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3 className="text-lg font-medium">Planned<br/>Maintenance</h3>
          </Link>
        </div>
        ...
        <div className="mb-16">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/services" className="text-primary hover:underline">See more</Link>
          </div>

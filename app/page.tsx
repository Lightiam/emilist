      ...
      <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-full max-w-4xl mx-auto">
              ...
              <div className="absolute inset-0 z-10 overflow-hidden">
                <img src="/assets/images/people/person1.jpg" alt="Professional" className="absolute top-10 left-10 w-16 h-16 rounded-full object-cover shadow-sm" />
                <img src="/assets/images/people/person2.jpg" alt="Professional" className="absolute top-32 left-16 w-16 h-16 rounded-full object-cover shadow-sm" />
                <img src="/assets/images/people/person3.jpg" alt="Professional" className="absolute top-16 right-16 w-16 h-16 rounded-full object-cover shadow-sm" />
                <img src="/assets/images/people/person4.jpg" alt="Professional" className="absolute bottom-16 left-20 w-16 h-16 rounded-full object-cover shadow-sm" />
                <img src="/assets/images/people/person5.jpg" alt="Professional" className="absolute bottom-32 right-12 w-16 h-16 rounded-full object-cover shadow-sm" />
                <img src="/assets/images/people/person6.jpg" alt="Professional" className="absolute bottom-8 right-24 w-16 h-16 rounded-full object-cover shadow-sm" />
              </div>
              
              {/* Center content */}
              <div className="text-center py-12 px-4 md:px-16 z-20 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-16">
          ...
          <Link href="/customized-service" className="bg-white rounded-lg shadow-xs p-4 flex flex-col items-center text-center hover:shadow-sm transition-shadow">
            ...
            <h3 className="text-sm font-medium">Customized Service<br/>Request</h3>
          </Link>

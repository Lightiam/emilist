    ...
    <Layout>
      <div className="container mx-auto px-4 py-6">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-full max-w-4xl mx-auto">
              ...
              <div className="absolute inset-0 z-0 overflow-hidden">
                <img src="/assets/images/people/person1.jpg" alt="Professional" className="absolute top-0 left-0 w-24 h-24 rounded-tl-3xl object-cover" />
                <img src="/assets/images/people/person2.jpg" alt="Professional" className="absolute top-32 left-16 w-24 h-24 rounded-full object-cover" />
                <img src="/assets/images/people/person3.jpg" alt="Professional" className="absolute top-0 right-0 w-24 h-24 rounded-tr-3xl object-cover" />
                <img src="/assets/images/people/person4.jpg" alt="Professional" className="absolute bottom-0 left-0 w-24 h-24 rounded-bl-3xl object-cover" />
                <img src="/assets/images/people/person5.jpg" alt="Professional" className="absolute bottom-32 right-12 w-24 h-24 rounded-full object-cover" />
                <img src="/assets/images/people/person6.jpg" alt="Professional" className="absolute bottom-0 right-0 w-24 h-24 rounded-br-3xl object-cover" />
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-16">
          <Link href="/service-providers" className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow transition-shadow">
            <div className="mb-4">
          ...
          <Link href="/job-opportunities" className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow transition-shadow">
            <div className="mb-4">
              <div className="w-12 h-12 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/materials" className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow transition-shadow">
            <div className="mb-4">
              <div className="w-12 h-12 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/customized-service" className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow transition-shadow">
            <div className="mb-4">
              <div className="w-12 h-12 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/planned-maintenance" className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow transition-shadow">
            <div className="mb-4">
              <div className="w-12 h-12 bg-[#E6F7EC] rounded-full flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
